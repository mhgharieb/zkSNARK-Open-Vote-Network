...
template HashInputs(size){
    ...
    hashInputs_2[0] = HashInputs_2(2);
    hashInputs_2[0].in[0] <== 0;
    hashInputs_2[0].in[1] <== in[0];
    
    for (var i=1; i<size;i++){
        hashInputs_2[i] = HashInputs_2(2);
...
template HashInputs3(size){
    ...
    hashInputs_3[0] = Poseidon(3);
    hashInputs_3[0].inputs[0] <== 0;
    hashInputs_3[0].inputs[1] <== in[0][0];
    hashInputs_3[0].inputs[2] <== in[0][1];
    
    for (var i=1; i<size;i++){
        hashInputs_3[i] = Poseidon(3);
        hashInputs_3[i].inputs[0] <== hashInputs_3[i-1].out;
        hashInputs_3[i].inputs[1] <== in[i][0];
        hashInputs_3[i].inputs[2] <== in[i][1];
    }
